...
void loop() 
{
 ...
 if (valL3==LOW && valL2==LOW && valL1==LOW && valCL==LOW && valCR==LOW && valR1==LOW && valR2==LOW && valR3==LOW && (previousERROR<=0))
  ...
  if ((valL3==HIGH && valL2==HIGH && valL1==HIGH && valCL==HIGH && valCR==HIGH && valR1==LOW && valR2==LOW && valR3==LOW) || (valL3==HIGH && valL2==HIGH && valL1==HIGH && valCL==HIGH && valCR==LOW && valR1==LOW && valR2==LOW && valR3==LOW) || (valL3==HIGH && valL2==HIGH && valL1==HIGH && valCL==LOW && valCR==LOW && valR1==LOW && valR2==LOW && valR3==LOW) || (valL3==HIGH && valL2==HIGH && valL1==HIGH && valCL==HIGH && valCR==HIGH && valR1==HIGH && valR2==LOW && valR3==LOW) )
  {
        //HARD LEFT TURN
 ...
 /*   Serial.print(valL3);
  ...
  if ((valL3==LOW && valL2==LOW && valL1==LOW && valCL==HIGH && valCR==HIGH && valR1==HIGH && valR2==HIGH && valR3==HIGH) || (valL3==LOW && valL2==LOW && valL1==LOW && valCL==LOW && valCR==HIGH && valR1==HIGH && valR2==HIGH && valR3==HIGH) || (valL3==LOW && valL2==LOW && valL1==LOW && valCL==LOW && valCR==LOW && valR1==HIGH && valR2==HIGH && valR3==HIGH) || (valL3==LOW && valL2==LOW && valL1==HIGH && valCL==HIGH && valCR==HIGH && valR1==HIGH && valR2==HIGH && valR3==HIGH) )
  {             
  ...
  if (FAST == 25)
  {
    analogWrite(leftA,220);
    analogWrite(leftB,0);
    analogWrite(rightA,220);
    analogWrite(rightB,0);
  }
